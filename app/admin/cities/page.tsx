							...
							<TableRow key={city.id}>
								...
								<TableCell>
									<div className="flex space-x-2">
										<Button className='flex items-center justify-center gap-2' variant="outline" onClick={() => console.log('Edit', city.id)}>
											<Edit />
											Edit
										</Button>
										<Button className='flex items-center justify-center gap-2' variant="outline" onClick={() => console.log('View', city.id)}>
											<Eye />
											View
										</Button>
									</div>
