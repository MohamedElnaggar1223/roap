// app/(on-boarding)/on-boarding/assessment/edit-assessment.tsx
'use client'
...
import AddPackage from '../program/new-add-package'
import EditPackage from '../program/new-edit-package'
import AutoGrowingTextarea from '@/components/ui/autogrowing-textarea'
import { formatDateForDB } from '@/lib/utils'
import { Package } from './assessment-form'
...
export default function EditAssessment({
    ...
    const [createdPackages, setCreatedPackages] = useState<Package[]>(packages)

    // Update parent when packages change
    // useEffect(() => {
    //     onUpdatePackages(createdPackages)
    // }, [createdPackages])
